 ...
 */
#define LV_USE_STDLIB_MALLOC    LV_STDLIB_CLIB // TvR: CLIB is available anyway
#define LV_USE_STDLIB_STRING    LV_STDLIB_CLIB // TvR: CLIB is available anyway
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_CLIB // TvR: CLIB is available anyway, and snprintf is better
 ...
 * - LV_OS_MQX
 * - LV_OS_CUSTOM */
// #define LV_USE_OS   LV_OS_FREERTOS    // TvR: Using FreeTOS is faster, but atomic.h is needed
...
#define LV_ATTRIBUTE_FAST_MEM           IRAM_ATTR // TvR: Place critical code into fast IRAM
...
// /*=================
//  *  TEXT SETTINGS -> lv_conf_project.h
//  *=================*/
