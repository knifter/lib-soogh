...
typedef enum : uint32_t
{
	...
	KEY_A_DOUBLE_PRESSED = KEY_A | KEYTOOL_DOUBLE_RELEASED,
	KEY_B_DOUBLE_PRESSED = KEY_B | KEYTOOL_DOUBLE_RELEASED,
	KEY_C_DOUBLE_PRESSED = KEY_C | KEYTOOL_DOUBLE_RELEASED,
